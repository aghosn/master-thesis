...
The continuation function is compiled with an entry point at the target of the backward-branch.
...
Jikes RVM is an extensible framework in which on-stack replacement techniques have been implemented in two steps, i.e., a first implementation\cite{fink2003design}, and then a augmented version of OSR\cite{soman2006efficient}.
%The first
