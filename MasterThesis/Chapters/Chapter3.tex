...
The McJIT OSR support\cite{lameed2013modular} is an attempt at providing an OSR library compatible with the standard LLVM implementation. 
...
The implementation has been tested in the MvVM/McJIT\cite{chevalier2010optimizing, McVM}, an open source VM and JIT for MATLAB, built on LLVM.
...
The McJIT library that provides OSR functionalities fit into the regular JIT infrastructure provided by LLVM as described in Figure \ref{MCJitArchitecture} taken from\cite{lameed2013modular}. 
\begin{figure}[h]
\centering
...
As a result, McJIT OSR support is a modular, and general purpose OSR library.\\
...
\hline
                                   & SELF Debugger & HotSpot & Graal & Jikes RVM & WebKit & McJIT OSR & OSR Kit \\ \hline
