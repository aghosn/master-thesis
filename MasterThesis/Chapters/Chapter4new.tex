...
All numeric data have to be boxed in R, leading to high overheads in programs containing an important amount of single numbers.
...
The body element of a SEXP closure is a function SEXP.
...
The \textit{getFunction} intrinsic, that enables to resolve a function, returns a closure.\\
