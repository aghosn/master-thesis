...
For dynamic languages and VMs, code specialization is an efficient technique to improve performances.
...
The OSR transition can therefore be viewed as a function call, from the source version, to the destination version containing the newly generated code.\\
