...
The VARMAP structure in the Jikes RVM~\cite{soman2006efficient} and the scope descriptors in SELF debugger~\cite{holzle1992debugging} are examples of such metadata attached to the code that enable to recover the values of $a$ and $b$ from $c$.\\
...
OSR strives to enable common optimizations performed by static programming languages compilers in dynamic language compilers.
